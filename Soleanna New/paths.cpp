...
LoopHead* Tropical0_paths[]{
	&HT0_LoopPath1,
	&HT0_LoopPath2,
	nullptr
};

PathDataPtr Tropical0_pathdata = { LevelAndActIDs_RedMountain1, Tropical0_paths };

LoopHead* Tropical1_paths[]{
	nullptr
};

PathDataPtr Tropical1_pathdata = { LevelAndActIDs_RedMountain2, Tropical1_paths };

LoopHead* Tropical2_paths[]{
	nullptr
};

PathDataPtr Tropical2_pathdata = { LevelAndActIDs_RedMountain3, Tropical2_paths };