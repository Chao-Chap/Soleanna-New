...
NJS_MODEL_SADX attach_020BFC48 = { vertex_020BFB88, normal_020BFBE8, LengthOfArray<Sint32>(vertex_020BFB88), meshlist_020BFB6C, matlist_020BFB40, LengthOfArray<Uint16>(meshlist_020BFB6C), LengthOfArray<Uint16>(matlist_020BFB40), { -1737.5f, -128, -1012 }, 3734.1628f, NULL };

NJS_OBJECT object_020BFC74 = { NJD_EVAL_UNIT_POS | NJD_EVAL_UNIT_ANG | NJD_EVAL_BREAK, &attach_020BFC48, 0, 0, 0, 0, 0, 0, 400, 400, 1, NULL, NULL };
